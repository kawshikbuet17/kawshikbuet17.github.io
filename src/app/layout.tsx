          ...
          <LocaleProvider config={runtimeI18n}>
            ...
            <Footer
              ...
              social={{
                ...
                google_scholar: config.social.google_scholar,
                orcid: config.social.orcid,
                research_gate: config.social.research_gate,
              }}
              navigation={config.navigation}
              cvDownloadUrl="https://drive.google.com/uc?export=download&id=1X7f04KoZkjBLtF09KK12ssOlfXxhkOaF"
            />
          </LocaleProvider>
        </ThemeProvider>
      </body>
